...
// DiscoverCatalogRoot loads policy-only private adversaries generated by
// `adversary catalog init`. Catalog entries are review policies, not executable
// adversary packages, so their README is the routing mission.
