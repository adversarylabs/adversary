...
func main() {
	...
	d := document{"SPDX-2.3", "CC0-1.0", "SPDXRef-DOCUMENT", "doomer-" + *version, "https://github.com/doomerlabs/doomer/sbom/" + *version, map[string]any{"created": time.Unix(epoch, 0).UTC().Format(time.RFC3339), "creators": []string{"Tool: doomer-release"}}, packages, rels}
