...
| CLI-008 | [#10](https://github.com/adversarylabs/adversary/pull/10), [#22](https://github.com/adversarylabs/adversary/pull/22), [#41](https://github.com/adversarylabs/adversary/pull/41), `api-jitter PR` | `docs/network-oci-policy.md` and API-client tests enforce bounded clients, request-cancelable credential helpers, bounded jittered exponential retries with capped `Retry-After`, redirect/realm policy, and sanitized failures. |
