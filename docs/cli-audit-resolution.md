...
| CLI-008 | [#10](https://github.com/adversarylabs/adversary/pull/10), [#22](https://github.com/adversarylabs/adversary/pull/22), credential-context PR | `docs/network-oci-policy.md` and API-client tests enforce bounded clients, request-cancelable credential helpers, safe retries, redirect/realm policy, and sanitized failures. |
