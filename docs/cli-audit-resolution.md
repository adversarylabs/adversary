...
| CLI-003 | [#4](https://github.com/adversarylabs/adversary/pull/4), [#35](https://github.com/adversarylabs/adversary/pull/35), [#39](https://github.com/adversarylabs/adversary/pull/39), [#40](https://github.com/adversarylabs/adversary/pull/40) | OAuth state, PKCE, exact loopback redirect, single-claim callback, failure cleanup, terminal premature server exits, and device-flow regression tests cover authentication boundaries. |
...
| CLI-006 | [#5](https://github.com/adversarylabs/adversary/pull/5), [#30](https://github.com/adversarylabs/adversary/pull/30), [#36](https://github.com/adversarylabs/adversary/pull/36) | Descriptor digests/sizes and config identity are cross-checked; runtime images use deterministic canonical OCI-reference validation. |
...
| CLI-008 | [#10](https://github.com/adversarylabs/adversary/pull/10), [#22](https://github.com/adversarylabs/adversary/pull/22), [#41](https://github.com/adversarylabs/adversary/pull/41), [#47](https://github.com/adversarylabs/adversary/pull/47) | `docs/network-oci-policy.md` and API-client tests enforce bounded clients, request-cancelable credential helpers, bounded jittered exponential retries with capped `Retry-After`, redirect/realm policy, and sanitized failures. |
...
| CLI-012 | [#5](https://github.com/adversarylabs/adversary/pull/5), [#6](https://github.com/adversarylabs/adversary/pull/6), [#7](https://github.com/adversarylabs/adversary/pull/7), [#8](https://github.com/adversarylabs/adversary/pull/8), [#9](https://github.com/adversarylabs/adversary/pull/9), [#11](https://github.com/adversarylabs/adversary/pull/11), [#12](https://github.com/adversarylabs/adversary/pull/12), [#36](https://github.com/adversarylabs/adversary/pull/36) | Repository publication, leases, lifecycle journals, migration checkpoints, check/GC behavior, and unified resolver migration are durable and regression-tested. |
| CLI-013 | [#1](https://github.com/adversarylabs/adversary/pull/1), [#23](https://github.com/adversarylabs/adversary/pull/23), [#31](https://github.com/adversarylabs/adversary/pull/31), [#42](https://github.com/adversarylabs/adversary/pull/42), [#43](https://github.com/adversarylabs/adversary/pull/43), [#44](https://github.com/adversarylabs/adversary/pull/44) | Versioned input/review/error schemas have Go/TypeScript parity, strict version rejection, caller-controlled suppression disclosure, terminal-control sanitization, and a completed staged migration from the legacy TypeScript rule-summary return to canonical-only default and write paths. |
...
| CLI-016 | [#3](https://github.com/adversarylabs/adversary/pull/3), [#23](https://github.com/adversarylabs/adversary/pull/23), [#45](https://github.com/adversarylabs/adversary/pull/45) | Project initialization is atomic and injected; generated TypeScript uses a deterministic lockfile and `npm ci`, and names are rejected before filesystem mutation unless they satisfy the maintained npm length and reserved-name boundary. |
...
| CLI-018 | [#19](https://github.com/adversarylabs/adversary/pull/19), [#45](https://github.com/adversarylabs/adversary/pull/45) | `docs/platform-runtime-support.md` records the OS/runtime matrix, captured executable discovery including deterministic Windows npm/node candidates, safe platform-specific init guidance, data/config locations, and native CI coverage. |
| CLI-019 | [#6](https://github.com/adversarylabs/adversary/pull/6), [#24](https://github.com/adversarylabs/adversary/pull/24), [#25](https://github.com/adversarylabs/adversary/pull/25), [#26](https://github.com/adversarylabs/adversary/pull/26), [#48](https://github.com/adversarylabs/adversary/pull/48) | Production package layers use bounded repeatable sources, owned temporary files, and repository leases end to end; whole-layer compatibility APIs were removed. `docs/coverage-boundaries.md` maps executable large-repository, many-change, large-review, and existing large-layer benchmarks. |
...
| CLI-021 | [#1](https://github.com/adversarylabs/adversary/pull/1), [#29](https://github.com/adversarylabs/adversary/pull/29), [#34](https://github.com/adversarylabs/adversary/pull/34), [#35](https://github.com/adversarylabs/adversary/pull/35), [#36](https://github.com/adversarylabs/adversary/pull/36), [#37](https://github.com/adversarylabs/adversary/pull/37), [#46](https://github.com/adversarylabs/adversary/pull/46), [#48](https://github.com/adversarylabs/adversary/pull/48) | `.depot/workflows/ci.yml` makes native tests, formatting, module verification, vet, race, coverage, five cross-builds, TypeScript/template and CLI smoke tests, security tooling, release contracts, and artifact transaction regressions dependencies of `ci / test`. Bounded glob, review-envelope, and archive-extraction fuzz targets close the remaining parser corpus gaps; their exact contracts are maintained in `docs/coverage-boundaries.md`. |
...
| CLI-024 | [#11](https://github.com/adversarylabs/adversary/pull/11), [#12](https://github.com/adversarylabs/adversary/pull/12), [#13](https://github.com/adversarylabs/adversary/pull/13), [#14](https://github.com/adversarylabs/adversary/pull/14), [#28](https://github.com/adversarylabs/adversary/pull/28), [#33](https://github.com/adversarylabs/adversary/pull/33), [#38](https://github.com/adversarylabs/adversary/pull/38), [#39](https://github.com/adversarylabs/adversary/pull/39), [#40](https://github.com/adversarylabs/adversary/pull/40), [#46](https://github.com/adversarylabs/adversary/pull/46), [#48](https://github.com/adversarylabs/adversary/pull/48) | Every effectful production command receives `application.App`; pure version/completion commands intentionally inherit root streams without unused authority. Projects, references, credentials, browser authentication, runtime processes, filesystems, persistent/coordination paths, environment, and streams cross replaceable ports. Internal host execution uses accurate `Runtime*` terminology, and package documentation now describes the completed injected boundary. |
