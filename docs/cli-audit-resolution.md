...
| CLI-007 | [#15](https://github.com/adversarylabs/adversary/pull/15), [#16](https://github.com/adversarylabs/adversary/pull/16), [#33](https://github.com/adversarylabs/adversary/pull/33), build-state composition PR | Builds are explicit, transactional, isolated from the source tree, and use captured executable/environment/process and canonical build-state dependencies for both pack and run. See `docs/build-and-git-contract.md`. |
...
| CLI-024 | [#11](https://github.com/adversarylabs/adversary/pull/11), [#12](https://github.com/adversarylabs/adversary/pull/12), [#13](https://github.com/adversarylabs/adversary/pull/13), [#14](https://github.com/adversarylabs/adversary/pull/14), [#28](https://github.com/adversarylabs/adversary/pull/28), [#33](https://github.com/adversarylabs/adversary/pull/33), build-state composition PR | Every production command receives `application.App`; projects, references, credentials, runtime processes, filesystems, persistent/coordination paths, environment, and streams cross replaceable ports. Hermetic pack/run tests reject post-construction cache-path drift. |
