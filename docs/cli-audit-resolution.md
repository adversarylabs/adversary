...
| CLI-021 | [#1](https://github.com/adversarylabs/adversary/pull/1), [#29](https://github.com/adversarylabs/adversary/pull/29), [#34](https://github.com/adversarylabs/adversary/pull/34), [#35](https://github.com/adversarylabs/adversary/pull/35), [#36](https://github.com/adversarylabs/adversary/pull/36), [#37](https://github.com/adversarylabs/adversary/pull/37), `final-closure PR` | `.depot/workflows/ci.yml` makes native tests, formatting, module verification, vet, race, coverage, five cross-builds, TypeScript/template and CLI smoke tests, security tooling, release contracts, and artifact transaction regressions dependencies of `ci / test`. The Go/Node/platform and hermetic registry/build matrices and live-fixture decisions are maintained and verifier-enforced. |
...
| CLI-024 | [#11](https://github.com/adversarylabs/adversary/pull/11), [#12](https://github.com/adversarylabs/adversary/pull/12), [#13](https://github.com/adversarylabs/adversary/pull/13), [#14](https://github.com/adversarylabs/adversary/pull/14), [#28](https://github.com/adversarylabs/adversary/pull/28), [#33](https://github.com/adversarylabs/adversary/pull/33), [#38](https://github.com/adversarylabs/adversary/pull/38), [#39](https://github.com/adversarylabs/adversary/pull/39), [#40](https://github.com/adversarylabs/adversary/pull/40), `final-closure PR` | Every effectful production command receives `application.App`; pure version/completion commands intentionally inherit root streams without unused authority. Projects, references, credentials, browser authentication, runtime processes, filesystems, persistent/coordination paths, environment, and streams cross replaceable ports. Internal host execution uses accurate `Runtime*` terminology, and hermetic/alias-aware AST tests reject ambient dependency and misleading-container regressions. |
