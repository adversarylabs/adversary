...
| CLI-019 | [#6](https://github.com/adversarylabs/adversary/pull/6), [#24](https://github.com/adversarylabs/adversary/pull/24), [#25](https://github.com/adversarylabs/adversary/pull/25), [#26](https://github.com/adversarylabs/adversary/pull/26), `coverage-boundaries PR` | Production package layers use bounded repeatable sources, owned temporary files, and repository leases end to end; whole-layer compatibility APIs were removed. `docs/coverage-boundaries.md` maps executable large-repository, many-change, large-review, and existing large-layer benchmarks. |
...
| CLI-021 | [#1](https://github.com/adversarylabs/adversary/pull/1), [#29](https://github.com/adversarylabs/adversary/pull/29), [#34](https://github.com/adversarylabs/adversary/pull/34), [#35](https://github.com/adversarylabs/adversary/pull/35), [#36](https://github.com/adversarylabs/adversary/pull/36), [#37](https://github.com/adversarylabs/adversary/pull/37), [#46](https://github.com/adversarylabs/adversary/pull/46), `coverage-boundaries PR` | `.depot/workflows/ci.yml` makes native tests, formatting, module verification, vet, race, coverage, five cross-builds, TypeScript/template and CLI smoke tests, security tooling, release contracts, and artifact transaction regressions dependencies of `ci / test`. Bounded glob, review-envelope, and archive-extraction fuzz targets close the remaining parser corpus gaps; their exact contracts are maintained in `docs/coverage-boundaries.md`. |
